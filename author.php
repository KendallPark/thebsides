...
<?php
	...
	if(isset($curauth->fb) || isset($curauth->gplus) || isset($curauth->pinterest) || isset($curauth->tweet)) { ?>
...
<?php
	...
	// Run a loop for the author archive page to output the authors posts if you want to include those...
?>
</section>
<?php get_sidebar(); ?>
<?php get_footer(); ?>